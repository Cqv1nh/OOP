package managers;
// Trang thai sau khi an nut load game
import entities.Button;
import util.Constants;
import util.GameStateData;
import util.RenderUtil;
import util.AssetManager; // Cần để lấy ảnh nền mini
import java.awt.*;
...
private final int SPACING = 40; // Khoảng cách giữa các slot
    ...
    /**
     * Hàm này đọc file save để lấy dữ liệu xem trước (hoặc trả về null)
     */
    ...
    /**
     * Hàm này thực hiện logic load game
